...
public class NetHelper
{
    public static Net Topo1()
    {
        ...
        Device r0 = new("R0_re", IPAddress.Loopback);
        Device r1 = new("R1_re", IPAddress.Loopback);
        Device r2 = new("R2_re", IPAddress.Loopback);
        net.AddDevice(r0);
        net.AddDevice(r1);
        net.AddDevice(r2);

        // add interfaces to devices
        var eth00 = new Interface("eth0/0", r0, IPAddress.Loopback, 24);
        var eth04 = new Interface("eth0/4", r0, IPAddress.Loopback, 24);
        r0.AddInterface(eth00);
        r0.AddInterface(eth04);

        var eth01 = new Interface("eth0/1", r1, IPAddress.Loopback, 24);
        var eth02 = new Interface("eth0/2", r1, IPAddress.Loopback, 24);
        r1.AddInterface(eth01);
        r1.AddInterface(eth02);

        var eth03 = new Interface("eth0/3", r2, IPAddress.Loopback, 24);
        var eth05 = new Interface("eth0/5", r2, IPAddress.Loopback, 24);
